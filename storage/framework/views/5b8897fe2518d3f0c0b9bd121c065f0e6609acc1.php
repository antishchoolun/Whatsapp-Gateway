...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">
		...
		<!-- jQuery -->
		<script type="application/javascript" src="<?php echo e(asset('assets/jquery/jquery-3.5.1.min.js')); ?>"></script>
		...
		<div class="ui main container" id="app">
			<div class="ui one column grid">
				...
				<div class="column">
					...
					<form class="ui grid form m-0" method="post" action="<?php echo e(route('settings.install_app')); ?>" enctype="multipart/form-data">
						<?php echo csrf_field(); ?>
						<div class="ui fluid card">
							...
							<div class="content body">
								...
								<div class="step general" :class="{active: stepIsActive(2)}">
                                  ...
                                  <div class="field">
                                    <button class="ui basic big fluid button rounded mx-0" type="button" @click="validateLicense($event)">Activate License</button>
                                </div>
							...
							<div class="content footer ">
								<button class="ui d-none  large previeus button ml-0 mr-auto" @click="navigateSteps(-1)" type="button" :class="{disabled: stepIsActive(1)}"><?php echo e(__('Previous')); ?></button>
								<button class="ui large next button ml-auto mr-0" @click="navigateSteps(1)" type="button"  v-if="step <= 3"><?php echo e(__('Next')); ?></button>
...
</html><?php /**PATH C:\xampp\htdocs\resources\views/install.blade.php ENDPATH**/ ?>