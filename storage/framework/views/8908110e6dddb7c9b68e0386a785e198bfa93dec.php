...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.layout-dashboard','data' => ['title' => 'Message Test']]); ?>
<?php $component->withName('layout-dashboard'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['title' => 'Message Test']); ?>
                                     ...
                                     <div class="card-body">
                                       ...
                                       <div class="example-container">
                                        <div class="example-content">
                                            <form action="<?php echo e(route('textMessageTest')); ?>" method="POST" id="formSendMsg">
                                                <?php echo csrf_field(); ?>
                                                <label for="textmessage" class="form-label">Sender</label>
                                                <input type="text" value=<?php echo e(Session::get('selectedDevice')); ?> name="sender" id="sender" class="form-control" readonly>
                            ...
                            <div class="tab-pane fade" id="image" role="tabpanel" aria-labelledby="security-tab">
                                <div class="card">
                                    <div class="card-body">
                                       ...
                                       <div class="example-container">
                                        <div class="example-content">
                                            <form action="<?php echo e(route('imageMessageTest')); ?>" method="POST" id="formSendMsg">
                                                <?php echo csrf_field(); ?>
                                                <label for="textmessage" class="form-label">Sender</label>
                                               <input type="text" value=<?php echo e(Session::get('selectedDevice')); ?> name="sender" id="sender" class="form-control" readonly>
                            ...
                            <div class="tab-pane fade" id="button" role="tabpanel" aria-labelledby="integrations-tab">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="example-container">
                                         <div class="example-content">
                                             <form action="<?php echo e(route('buttonMessageTest')); ?>" method="POST" id="formSendMsg">
                                                 <?php echo csrf_field(); ?>
                                                 <label for="textmessage" class="form-label">Sender</label>
                            ...
                            <div class="tab-pane fade" id="template" role="tabpanel" aria-labelledby="integrations-tab">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="example-container">
                                         <div class="example-content">
                                             <form action="<?php echo e(route('templateMessageTest')); ?>" method="POST" id="formSendMsg">
                                                 <?php echo csrf_field(); ?>
                                                 <label for="textmessage" class="form-label">Sender</label>
                              ...
                              <div class="tab-pane fade" id="list" role="tabpanel" aria-labelledby="integrations-tab">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="example-container">
                                         <div class="example-content">
                                             <form action="<?php echo e(route('listMessageTest')); ?>" method="POST" id="formSendMsg">
                                                 <?php echo csrf_field(); ?>
                                                 <label for="textmessage" class="form-label">Sender</label>
...
</script><?php /**PATH C:\xampp\htdocs\resources\views/pages/messagetest.blade.php ENDPATH**/ ?>